...
const iconData = {
    ...
    '#philm': [
        ...
        { u: 'youtu.be/wtLEERCi5xw', i: 'gridlock' },
        ...
        { u: 'youtu.be/t_Wdy1WOXqQ', i: 'denders' },
        { u: 'youtu.be/sJ5ZEQGiVcw', i: 'fry' },
        { u: 'youtu.be/O2Yea-nuoZs', i: 'moon' },
        { u: 'youtu.be/aj5jr794EEA', i: 'call-center' },
        { u: 'youtu.be/4VrLQXR7mKU', i: 'robot' },
        { u: 'youtu.be/F62KXQCiC-s', i: 'voices' },
        { u: 'youtu.be/x6jTKBwOEEE', i: 'switch' },
        { u: 'youtu.be/PGgRH7-Qs9g', i: 'tell' },
        { u: 'youtu.be/js2932fcKOU', i: 'turn-around' },
        { u: 'youtu.be/KhTFZHItHvI', i: 'remmy' },
        { u: 'youtu.be/CwCPy2qVqwM', i: 'cheater' },
        ...
        { u: 'youtu.be/QK8LEfLQg_M', i: 'vwall' },
    ...
    '#ahhhrt': [
        ...
        { u: 'www.katiebrooksart.com/gallery', i: 'kbrooks' },
